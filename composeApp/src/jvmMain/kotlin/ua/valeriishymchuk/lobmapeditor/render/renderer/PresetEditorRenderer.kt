...
class PresetEditorRenderer(di: DI) : EditorRenderer<GameScenario.Preset, PresetRenderContext>(di) {

    val presetEditorService: PresetEditorService by lazy {
        editorService as PresetEditorService
    }
    ...
    override fun prepareContext(gl: CurrentGL): PresetRenderContext {
        return PresetRenderContext(
            gl,
