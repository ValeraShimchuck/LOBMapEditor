...
enum class TerrainType(val id: Int, val textureLocation: String, val dominance: Int ,val mainTerrain: TerrainType? = null, additionalLocation: String? = null) {
    ...
    FARM(11, "terrain/farm", dominance = 6),
    ...
    FARM_UNPLANTED(17, "terrain/farm-unplanted", dominance = 7, additionalLocation = "borderblending/farm-borders"),
    FARM_GROWING(18, "terrain/farm-growing", dominance = 8, additionalLocation = "borderblending/farm-borders"),
